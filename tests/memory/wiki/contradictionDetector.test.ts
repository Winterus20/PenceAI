...
describe('ContradictionDetector', () => {
  ...
  it('detects explicit contradicts relation', async () => {
    ...
    db.prepare("INSERT INTO memory_relations (source_memory_id, target_memory_id, relation_type, description) VALUES (?, ?, ?, ?)")
  ...
  it('dedups pairs via normalization', async () => {
    ...
    db.prepare("INSERT INTO memory_relations (source_memory_id, target_memory_id, relation_type) VALUES (?, ?, ?)")
      .run(a, b, 'contradicts');
