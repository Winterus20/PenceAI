...
| Azure Auth | @azure/core-auth | 1.10+ | Azure kimlik doğrulama |
| Azure SSE | @azure/core-sse | 2.3+ | Azure Server-Sent Events |
| OpenTelemetry | @opentelemetry/api | 1.9+ | Telemetri API |
| OpenTelemetry | @opentelemetry/sdk-node | 0.214+ | Node.js telemetri SDK |
...
| Icons | Lucide React | 0.577+ | İkon seti |
| Font | @fontsource/inter | 5.2+ | Inter web fontu |
| Toast | react-hot-toast | 2.6+ | Bildirim toasts |
| Utility | class-variance-authority | 0.7+ | CSS variant yardımcısı |
| Utility | clsx | 2.1+ | Koşullu CSS sınıfları |
| Utility | tailwind-merge | 3.5+ | Tailwind sınıf birleştirme |
| Radix Visually Hidden | @radix-ui/react-visually-hidden | 1.2+ | Erişilebilirlik gizleme |
| Radix Slot | @radix-ui/react-slot | 1.2+ | Polymorphic slot |
...
| Browser | puppeteer | 24.40+ | Headless browser testleri |
| Formatting | pino-pretty | 13.1+ | Pino log formatlama (dev) |
| Runner | tsx | 4.19+ | TypeScript çalıştırıcı |
